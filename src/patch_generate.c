...
static int patch_generated_normalize_options(git_diff_options *out,
...
static int patch_generated_init(git_patch_generated *patch, git_diff *diff, size_t delta_index)
{
	int error = 0;
...
static int patch_generated_alloc_from_diff(git_patch_generated **out,
	git_diff *diff,
	size_t delta_index)
{
	int error;
...
static int patch_generated_load(git_patch_generated *patch,
...
static int patch_generated_invoke_file_callback(git_patch_generated *patch,
	git_patch_generated_output *output)
{
...
static int create_binary(git_diff_binary_t *out_type,
	char **out_data,
	size_t *out_datalen,
...
static int patch_generated_create(git_patch_generated *patch,
	git_patch_generated_output *output)
{
	int error = 0;
...
static int patch_from_sources(git_patch **out,
	git_diff_file_content_src *oldsrc,
	git_diff_file_content_src *newsrc,
	const git_diff_options *opts)
{
...
int git_diff_blobs(const git_blob *old_blob,
	const char *old_path,
...
int git_patch_from_blobs(git_patch **out,
...
int git_diff_blob_to_buffer(const git_blob *old_blob,
	const char *old_path,
	const char *buf,
	size_t buflen,
	const char *buf_path,
...
int git_patch_from_blob_and_buffer(git_patch **out,
	const git_blob *old_blob,
	const char *old_path,
	const void *buf,
	size_t buflen,
...
int git_diff_buffers(const void *old_buf,
	size_t old_len,
	const char *old_path,
	const void *new_buf,
	size_t new_len,
...
int git_patch_from_buffers(git_patch **out,
	const void *old_buf,
	size_t old_len,
	const char *old_path,
	const void *new_buf,
...
static int patch_generated_file_cb(const git_diff_delta *delta, float progress, void *payload)
{
	GIT_UNUSED(delta);
	GIT_UNUSED(progress);
	GIT_UNUSED(payload);
...
static int patch_generated_binary_cb(const git_diff_delta *delta,
...
static int git_patch_hunk_cb(const git_diff_delta *delta,
...
static void diff_output_to_patch(git_patch_generated_output *out,
	git_patch_generated *patch)
{
