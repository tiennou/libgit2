...
static git_diff_driver_definition builtin_defs[] = {
	...
	IPATTERN("fortran",
		...
		/* -- */
		"[a-zA-Z][a-zA-Z0-9_]*"
		"|\\.([Ee][Qq]|[Nn][Ee]|[Gg][TtEe]|[Ll][TtEe]|[Tt][Rr][Uu][Ee]|[Ff][Aa]"
		"[Ll][Ss][Ee]|[Aa][Nn][Dd]|[Oo][Rr]|[Nn]?[Ee][Qq][Vv]|[Nn][Oo][Tt])\\."
		/* numbers and format statements like 2E14.4, or ES12.6, 9X.
		 * Don't worry about format statements without leading digits since
		 * they would have been matched above as a variable anyway. */
		"|[-+]?[0-9.]+([AaIiDdEeFfLlTtXx][Ss]?[-+]?[0-9.]*)?(_[a-zA-Z0-9][a-zA-"
		"Z0-9_]*)?"
		"|//|\\*\\*|::|[/<>=]="),
	...
	PATTERNS("matlab", "^[[:space:]]*((classdef|function)[[:space:]].*)$|^%%[[:space:]].*$",
	...
	PATTERNS("csharp",
		/* Keywords */
		"!^[ "
		"\t]*(do|while|for|if|else|instanceof|new|return|switch|case|throw|"
		"catch|using)\n"
		/* Methods and constructors */
		"^[ "
		"\t]*(((static|public|internal|private|protected|new|virtual|sealed|"
		"override|unsafe)[ \t]+)*[][<>@.~_[:alnum:]]+[ \t]+[<>@._[:alnum:]]+[ "
		"\t]*\\(.*\\))[ \t]*$\n"
		/* Properties */
		"^[ "
		"\t]*(((static|public|internal|private|protected|new|virtual|sealed|"
	...
	PATTERNS("php", "^[ \t]*(((public|private|protected|static|final)[ \t]+)*((class|function)[ \t].*))$",
		/* -- */
		"[a-zA-Z_][a-zA-Z0-9_]*"
	...
	PATTERNS("javascript",
		"([a-zA-Z_$][a-zA-Z0-9_$]*(\\.[a-zA-Z0-9_$]+)*[ \t]*=[ \t]*function([ "
		"\t][a-zA-Z_$][a-zA-Z0-9_$]*)?[^\\{]*)\n"
