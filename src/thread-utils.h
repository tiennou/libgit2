...
GIT_INLINE(void)
git_atomic_set(git_atomic *a, int val)
{
#	if defined(GIT_WIN32)
...
GIT_INLINE(int)
git_atomic_add(git_atomic *a, int32_t addend)
{
#	if defined(GIT_WIN32)
...
GIT_INLINE(int64_t)
git_atomic64_add(git_atomic64 *a, int64_t addend)
{
#		if defined(GIT_WIN32)
...
GIT_INLINE(int)
git_mutex_init(git_mutex *mutex)
{
	GIT_UNUSED(mutex);
	return 0;
}
GIT_INLINE(int)
git_mutex_lock(git_mutex *mutex)
{
	GIT_UNUSED(mutex);
	return 0;
}
