...
int git_odb__format_object_header(size_t *written,
	char *hdr,
	size_t hdr_size,
	git_off_t obj_len,
	git_otype obj_type)
...
static int add_backend_internal(git_odb *odb,
	git_odb_backend *backend,
	int priority,
	bool is_alternate,
	ino_t disk_inode)
...
int git_odb__add_default_backends(git_odb *db,
...
static int odb_exists_prefix_1(git_oid *out,
	git_odb *db,
	const git_oid *key,
	size_t len,
	bool only_refreshed)
...
static int odb_read_header_1(size_t *len_p,
	git_otype *type_p,
	git_odb *db,
	const git_oid *id,
	bool only_refreshed)
...
int git_odb__read_header_or_object(git_odb_object **out,
	size_t *len_p,
	git_otype *type_p,
	git_odb *db,
	const git_oid *id)
...
static int odb_read_1(git_odb_object **out, git_odb *db, const git_oid *id, bool only_refreshed)
{
	size_t i;
	git_rawobj raw;
	git_odb_object *object;
...
static int read_prefix_1(git_odb_object **out,
	git_odb *db,
	const git_oid *key,
	size_t len,
	bool only_refreshed)
...
int git_odb_open_wstream(git_odb_stream **stream, git_odb *db, git_off_t size, git_otype type)
{
	size_t i, writes = 0;
	int error = GIT_ERROR;
...
int git_odb_open_rstream(git_odb_stream **stream,
	size_t *len,
	git_otype *type,
	git_odb *db,
	const git_oid *oid)
