 ...
 */
extern int git_delta_create_from_index(void **out, size_t *out_size,
	const struct git_delta_index *index, const void *buf, size_t bufsize,
 ...
 */
GIT_INLINE(int)
git_delta(void **out, size_t *out_len, const void *src_buf, size_t src_bufsize,
	const void *trg_buf, size_t trg_bufsize, size_t max_delta_size)
{
 ...
 */
extern int git_delta_apply(void **out, size_t *out_len, const unsigned char *base,
 ...
 * @return 0 on success or an error code
 */
extern int git_delta_read_header(size_t *base_out, size_t *result_out,
