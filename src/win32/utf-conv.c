...
int git__utf8_to_16(wchar_t *dest, size_t dest_size, const char *src)
{
	...
	if ((len = MultiByteToWideChar(CP_UTF8, MB_ERR_INVALID_CHARS, src, -1, dest,
				   (int)dest_size) -
				1) < 0)
		git__set_errno();
...
int git__utf16_to_8(char *dest, size_t dest_size, const wchar_t *src)
{
	...
	if ((len = WideCharToMultiByte(CP_UTF8, WC_ERR_INVALID_CHARS, src, -1, dest,
				   (int)dest_size, NULL, NULL) -
				1) < 0)
		git__set_errno();
...
int git__utf8_to_16_alloc(wchar_t **dest, const char *src)
{
	...
	*dest = NULL;
	...
	utf16_size = MultiByteToWideChar(
		CP_UTF8, MB_ERR_INVALID_CHARS, src, -1, *dest, utf16_size);
...
int git__utf16_to_8_alloc(char **dest, const wchar_t *src)
{
	...
	*dest = NULL;
	...
	utf8_size = WideCharToMultiByte(
		CP_UTF8, WC_ERR_INVALID_CHARS, src, -1, NULL, 0, NULL, NULL);
	...
	*dest = git__malloc(utf8_size);
	...
	utf8_size = WideCharToMultiByte(
		CP_UTF8, WC_ERR_INVALID_CHARS, src, -1, *dest, utf8_size, NULL, NULL);
