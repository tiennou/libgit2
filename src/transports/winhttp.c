 ...
 * into the input.
 */
static int userpass_from_url(
	wchar_t **user, int *user_len, wchar_t **pass, int *pass_len, const wchar_t *url, int url_len)
{
...
static void CALLBACK winhttp_status(
	HINTERNET connection, DWORD_PTR ctx, DWORD code, LPVOID info, DWORD info_len)
{
	DWORD status;
