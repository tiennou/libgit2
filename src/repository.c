...
static int find_repo(git_buf *gitdir_path,
...
int git_repository_open_ext(git_repository **repo_ptr,
	const char *start_path,
	unsigned int flags,
	const char *ceiling_dirs)
{
...
static int load_config(git_config **out,
	git_repository *repo,
...
static int repo_local_config(
	git_config **out, git_buf *config_dir, git_repository *repo, const char *repo_dir)
{
	int error = 0;
	git_config *parent;
	const char *cfg_path;
...
static int repo_init_fs_configs(git_config *cfg,
	const char *cfg_path,
	const char *repo_dir,
	const char *work_dir,
...
static int repo_write_template(const char *git_dir,
...
static int repo_init_structure(
	const char *repo_dir, const char *work_dir, git_repository_init_options *opts)
{
	int error = 0;
...
static int repo_init_directories(git_buf *repo_path,
	git_buf *wd_path,
...
int git_repository_init_ext(
	git_repository **out, const char *given_repo, git_repository_init_options *opts)
{
	int error;
