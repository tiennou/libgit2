 ...
 */
extern int git_index__find_pos(size_t *at_pos, git_index *index,
...
extern int git_index_snapshot_find(size_t *at_pos, git_vector *snap,
 ...
 * the index.
 */
extern int git_indexwriter_init_for_operation(git_indexwriter *writer,
