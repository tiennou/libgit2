...
static int ensure_there_are_changes_to_stash(
	git_repository *repo, bool include_untracked_files, bool include_ignored_files)
{
	int error;
...
static int reset_index_and_workdir(
	git_repository *repo, git_commit *commit, bool remove_untracked, bool remove_ignored)
{
...
int git_stash_apply(
	git_repository *repo, size_t index, const git_stash_apply_options *given_opts)
{
