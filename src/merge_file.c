...
static void merge_file_normalize_opts(git_merge_file_options *out,
...
static git_merge_file_input *git_merge_file__normalize_inputs(git_merge_file_input *out,
...
int git_merge_file_from_index(git_merge_file_result *out,
	git_repository *repo,
