...
extern int git_submodule__status(unsigned int *out_status, git_oid *out_head_id,
 ...
 */
extern int git_submodule_name_is_valid(
	git_repository *repo, const char *name, int flags);
