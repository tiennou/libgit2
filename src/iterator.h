...
extern int git_iterator_for_nothing(git_iterator **out, git_iterator_options *options);
 ...
 */
extern int git_iterator_for_index(git_iterator **out, git_repository *repo,
	git_index *index, git_iterator_options *options);

extern int git_iterator_for_workdir_ext(git_iterator **out,
	git_repository *repo, const char *repo_workdir, git_index *index,
	git_tree *tree, git_iterator_options *options);

/* workdir iterators will match the ignore_case value from the index of the
 * repository, unless you override with a non-zero flag value
 */
GIT_INLINE(int)
git_iterator_for_workdir(git_iterator **out, git_repository *repo,
	git_index *index, git_tree *tree, git_iterator_options *options)
{
 ...
 */
GIT_INLINE(int)
git_iterator_current(const git_index_entry **entry, git_iterator *iter)
{
 ...
 */
GIT_INLINE(int)
git_iterator_advance(const git_index_entry **entry, git_iterator *iter)
{
 ...
 */
GIT_INLINE(int)
git_iterator_advance_into(const git_index_entry **entry, git_iterator *iter)
{
 ...
 */
GIT_INLINE(int)
git_iterator_advance_over(const git_index_entry **entry,
	git_iterator_status_t *status, git_iterator *iter)
{
...
extern void git_iterator_set_ignore_case(git_iterator *iter, bool ignore_case);
 ...
 */
extern int git_iterator_current_workdir_path(git_buf **path, git_iterator *iter);
...
typedef int (*git_iterator_walk_cb)(const git_index_entry **entries, void *data);
