...
typedef struct {
	...
	int (*advance_over)(const git_index_entry **, git_iterator_status_t *, git_iterator *);
 ...
 */
extern int git_iterator_for_tree(git_iterator **out,
	git_tree *tree,
 ...
 */
extern int git_iterator_for_index(git_iterator **out,
	git_repository *repo,
	git_index *index,
	git_iterator_options *options);
 ...
 */
GIT_INLINE(int)
git_iterator_for_workdir(git_iterator **out,
	git_repository *repo,
	git_index *index,
	git_tree *tree,
	git_iterator_options *options)
 ...
 */
extern int git_iterator_for_filesystem(git_iterator **out,
	const char *root,
	git_iterator_options *options);
 ...
 */
extern int git_iterator_reset_range(git_iterator *iter, const char *start, const char *end);
...
extern int git_iterator_current_tree_entry(const git_tree_entry **entry_out,
	git_iterator *iter);

extern int git_iterator_current_parent_tree(const git_tree **tree_out,
	git_iterator *iter,
	size_t depth);
 ...
 */
extern int git_iterator_walk(git_iterator **iterators,
	size_t cnt,
