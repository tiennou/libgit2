...
static git_blame_hunk *new_hunk(size_t start, size_t lines, size_t orig_start, const char *path)
{
...
static int normalize_options(git_blame_options *out,
...
static git_blame_hunk *split_hunk_in_vector(git_vector *vec,
	git_blame_hunk *hunk,
	size_t rel_line,
	bool return_new)
{
...
int git_blame_file(git_blame **out,
	git_repository *repo,
	const char *path,
...
static int buffer_hunk_cb(const git_diff_delta *delta, const git_diff_hunk *hunk, void *payload)
{
