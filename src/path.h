 ...
 */
extern int git_path_direach(git_buf *pathbuf, uint32_t flags,
	int (*callback)(void *payload, git_buf *path), void *payload);

/**
 * Sort function to order two paths
 */
extern int git_path_cmp(const char *name1, size_t len1, int isdir1, const char *name2,
 ...
 */
extern int git_path_walk_up(git_buf *pathbuf, const char *ceiling,
	int (*callback)(void *payload, const char *path), void *payload);
...
extern int git_path_diriter_init(
	git_path_diriter *diriter, const char *path, unsigned int flags);
...
extern int git_path_diriter_filename(
	const char **out, size_t *out_len, git_path_diriter *diriter);
