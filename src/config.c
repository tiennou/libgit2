...
static int git_config__add_internal(git_config *cfg,
	file_internal *internal,
	git_config_level_t level,
	int force)
{
...
int git_config_open_level(git_config **cfg_out,
...
int git_config_foreach_match(const git_config *cfg,
	const char *regexp,
	git_config_foreach_cb cb,
	void *payload)
{
...
int git_config__lookup_entry(git_config_entry **out,
	const git_config *cfg,
	const char *key,
	bool no_errors)
{
...
int git_config_get_mapped(int *out,
	const git_config *cfg,
	const char *name,
...
int git_config_lookup_map_value(int *out,
	const git_cvar_map *maps,
	size_t map_n,
	const char *value)
{
