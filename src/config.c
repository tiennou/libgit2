...
static int find_internal_file_by_level(
	file_internal **internal_out, const git_config *cfg, git_config_level_t level)
{
	int pos = -1;
	file_internal *internal;
	size_t i;
...
static int git_config__add_internal(
	git_config *cfg, file_internal *internal, git_config_level_t level, int force)
{
	int result;
...
int git_config_open_level(
	git_config **cfg_out, const git_config *cfg_parent, git_config_level_t level)
{
	git_config *cfg;
	file_internal *internal;
	int res;
...
int git_config_backend_foreach_match(
	git_config_backend *backend, const char *regexp, git_config_foreach_cb cb, void *payload)
{
...
int git_config_foreach_match(
	const git_config *cfg, const char *regexp, git_config_foreach_cb cb, void *payload)
{
	int error;
	git_config_iterator *iter;
	git_config_entry *entry;
...
static int get_backend_for_use(
	git_config_backend **out, git_config *cfg, const char *name, backend_use use)
{
	size_t i;
	file_internal *f;
...
int git_config__update_entry(git_config *config,
	const char *key,
	const char *value,
...
static int get_entry(git_config_entry **out,
	const git_config *cfg,
	const char *name,
	bool normalize_name,
	int want_errors)
...
int git_config__lookup_entry(
	git_config_entry **out, const git_config *cfg, const char *key, bool no_errors)
{
	return get_entry(out, cfg, key, false, no_errors ? GET_NO_ERRORS : GET_NO_MISSING);
}

int git_config_get_mapped(
	int *out, const git_config *cfg, const char *name, const git_cvar_map *maps, size_t map_n)
{
	git_config_entry *entry;
	int ret;
...
int git_config_get_multivar_foreach(const git_config *cfg,
	const char *name,
	const char *regexp,
...
int git_config_multivar_iterator_new(
	git_config_iterator **out, const git_config *cfg, const char *name, const char *regexp)
{
...
int git_config_rename_section(
	git_repository *repo, const char *old_section_name, const char *new_section_name)
{
	git_config *config;
