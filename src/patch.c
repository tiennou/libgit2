...
int git_patch__invoke_callbacks(git_patch *patch, git_diff_file_cb file_cb,
...
size_t git_patch_size(git_patch *patch, int include_context,
	int include_hunk_headers, int include_file_headers)
{
	size_t out;
...
int git_patch_line_stats(size_t *total_ctxt, size_t *total_adds,
	size_t *total_dels, const git_patch *patch)
{
	size_t totals[3], idx;
...
int git_patch_get_hunk(const git_diff_hunk **out, size_t *lines_in_hunk,
...
int git_patch_get_line_in_hunk(const git_diff_line **out, git_patch *patch,
