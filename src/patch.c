...
size_t git_patch_size(git_patch *patch,
	int include_context,
...
int git_patch_line_stats(size_t *total_ctxt,
	size_t *total_adds,
	size_t *total_dels,
...
int git_patch_get_hunk(const git_diff_hunk **out,
...
int git_patch_get_line_in_hunk(const git_diff_line **out,
	git_patch *patch,
	size_t hunk_idx,
	size_t line_of_hunk)
{
