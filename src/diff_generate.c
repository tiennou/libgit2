...
static int diff_insert_delta(
	git_diff_generated *diff, git_diff_delta *delta, const char *matched_pathspec)
{
	int error = 0;
...
static int diff_delta__from_one(git_diff_generated *diff,
	git_delta_t status,
...
static int diff_delta__from_two(git_diff_generated *diff,
	git_delta_t status,
...
int git_diff__oid_for_file(
	git_oid *out, git_diff *diff, const char *path, uint16_t mode, git_off_t size)
{
...
int git_diff__oid_for_entry(
	git_oid *out, git_diff *d, const git_index_entry *src, uint16_t mode, const git_oid *update_match)
{
	git_diff_generated *diff;
...
static int maybe_modified_submodule(git_delta_t *status,
	git_oid *found_oid,
	git_diff_generated *diff,
...
static int iterator_advance_over(
	const git_index_entry **entry, git_iterator_status_t *status, git_iterator *iterator)
{
...
int git_diff__from_iterators(git_diff **out,
	git_repository *repo,
	git_iterator *old_iter,
	git_iterator *new_iter,
...
int git_diff_tree_to_tree(git_diff **out,
	git_repository *repo,
	git_tree *old_tree,
	git_tree *new_tree,
	const git_diff_options *opts)
...
int git_diff_tree_to_index(git_diff **out,
	git_repository *repo,
	git_tree *old_tree,
	git_index *index,
	const git_diff_options *opts)
...
int git_diff_index_to_workdir(
	git_diff **out, git_repository *repo, git_index *index, const git_diff_options *opts)
{
	git_diff *diff = NULL;
	int error = 0;
...
int git_diff_tree_to_workdir(
	git_diff **out, git_repository *repo, git_tree *old_tree, const git_diff_options *opts)
{
	git_diff *diff = NULL;
	git_index *index;
	int error = 0;
...
int git_diff_tree_to_workdir_with_index(
	git_diff **out, git_repository *repo, git_tree *tree, const git_diff_options *opts)
{
...
int git_diff_index_to_index(git_diff **out,
	git_repository *repo,
	git_index *old_index,
	git_index *new_index,
	const git_diff_options *opts)
...
int git_diff__paired_foreach(git_diff *head2idx,
	git_diff *idx2wd,
...
int git_diff__commit(git_diff **out,
	git_repository *repo,
