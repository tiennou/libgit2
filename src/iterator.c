...
static int iterator_init_common(git_iterator *iter,
	git_repository *repo,
	git_index *index,
...
static iterator_pathlist_search_t iterator_pathlist_search(git_iterator *iter,
	const char *path,
	size_t path_len)
{
	const char *p;
...
static int empty_iterator_advance_over(const git_index_entry **e,
...
static int tree_iterator_frame_init(tree_iterator *iter,
	git_tree *tree,
...
static void tree_iterator_set_current(tree_iterator *iter,
	tree_iterator_frame *frame,
...
static int tree_iterator_advance_over(const git_index_entry **out,
...
int git_iterator_for_tree(git_iterator **out, git_tree *tree, git_iterator_options *options)
{
	tree_iterator *iter;
	int error;
...
int git_iterator_current_parent_tree(const git_tree **parent_tree,
	git_iterator *i,
	size_t depth)
{
	tree_iterator *iter;
 ...
 */
static int filesystem_iterator_is_submodule(bool *out,
...
static int filesystem_iterator_frame_push(filesystem_iterator *iter,
	filesystem_iterator_entry *frame_entry)
{
...
static void filesystem_iterator_set_current(filesystem_iterator *iter,
	filesystem_iterator_entry *entry)
{
...
static int filesystem_iterator_advance_into(const git_index_entry **out,
	git_iterator *i)
{
	filesystem_iterator *iter = (filesystem_iterator *)i;
	filesystem_iterator_frame *frame;
...
static int filesystem_iterator_advance_over(const git_index_entry **out,
	git_iterator_status_t *status,
	git_iterator *i)
{
	filesystem_iterator *iter = (filesystem_iterator *)i;
...
static int iterator_for_filesystem(git_iterator **out,
	git_repository *repo,
	const char *root,
	git_index *index,
	git_tree *tree,
...
int git_iterator_for_filesystem(git_iterator **out,
	const char *root,
	git_iterator_options *options)
{
...
int git_iterator_for_workdir_ext(git_iterator **out,
	git_repository *repo,
...
static bool index_iterator_create_pseudotree(const git_index_entry **out,
	index_iterator *iter,
	const char *path)
{
...
static int index_iterator_advance_over(const git_index_entry **out,
	git_iterator_status_t *status,
	git_iterator *i)
{
	index_iterator *iter = (index_iterator *)i;
...
int git_iterator_for_index(git_iterator **out,
	git_repository *repo,
	git_index *index,
	git_iterator_options *options)
{
...
int git_iterator_walk(git_iterator **iterators, size_t cnt, git_iterator_walk_cb cb, void *data)
{
