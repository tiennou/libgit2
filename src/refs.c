...
static int reference_normalize_for_repo(git_refname_t out,
	git_repository *repo,
	const char *name,
	bool validate)
{
...
int git_reference_lookup_resolved(git_reference **ref_out,
	git_repository *repo,
	const char *name,
	int max_nesting)
{
...
int git_reference_foreach(git_repository *repo,
...
int git_reference_foreach_name(git_repository *repo,
...
int git_reference_normalize_name(char *buffer_out,
	size_t buffer_size,
	const char *name,
	unsigned int flags)
{
