...
static int lookup_remote_prune_config(git_remote *remote,
	git_config *config,
	const char *name);
...
static int write_add_refspec(git_repository *repo,
	const char *name,
	const char *refspec,
	bool fetch)
{
...
static int create_internal(git_remote **out,
	git_repository *repo,
	const char *name,
	const char *url,
	const char *fetch)
...
int git_remote_create_with_fetchspec(git_remote **out,
	git_repository *repo,
	const char *name,
	const char *url,
	const char *fetch)
...
static int get_optional_config(bool *found,
	git_config *config,
	git_buf *buf,
...
static int remote_head_for_fetchspec_src(git_remote_head **out,
...
static int git_remote_write_fetchhead(git_remote *remote,
	git_refspec *spec,
	git_vector *update_heads)
{
...
int git_remote_set_autotag(git_repository *repo,
	const char *remote,
...
static int rename_remote_config_section(git_repository *repo,
	const char *old_name,
	const char *new_name)
{
...
static int update_branch_remote_config_entry(git_repository *repo,
	const char *old_name,
	const char *new_name)
{
	int error;
...
static int rename_remote_references(git_repository *repo,
	const char *old_name,
	const char *new_name)
{
	int error;
...
static int remove_branch_config_related_entries(git_repository *repo,
...
int git_remote_upload(git_remote *remote,
	const git_strarray *refspecs,
