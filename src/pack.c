...
static int packfile_unpack_compressed(git_rawobj *obj,
 ...
 */
static int pack_entry_find_offset(git_off_t *offset_out,
	git_oid *found_oid,
	struct git_pack_file *p,
...
static int cache_add(git_pack_cache_entry **cached_out,
...
static unsigned char *pack_window_open(
	struct git_pack_file *p, git_mwindow **w_cursor, git_off_t offset, unsigned int *left)
{
...
static int packfile_unpack_header1(unsigned long *usedp,
	size_t *sizep,
	git_otype *type,
...
int git_packfile_unpack_header(size_t *size_p,
	git_otype *type_p,
...
int git_packfile_resolve_header(
	size_t *size_p, git_otype *type_p, struct git_pack_file *p, git_off_t offset)
{
 ...
 * header starts
 */
git_off_t get_delta_base(struct git_pack_file *p,
	git_mwindow **w_curs,
	git_off_t *curpos,
	git_otype type,
...
int git_pack_entry_find(
	struct git_pack_entry *e, struct git_pack_file *p, const git_oid *short_oid, size_t len)
{
	git_off_t offset;
	git_oid found_oid;
	int error;
