...
extern bool git_diff_delta__should_skip(const git_diff_options *opts,
	const git_diff_delta *delta);

extern int git_diff__from_iterators(git_diff **diff_ptr,
	git_repository *repo,
	git_iterator *old_iter,
	git_iterator *new_iter,
	const git_diff_options *opts);

extern int git_diff__commit(git_diff **diff,
	git_repository *repo,
	const git_commit *commit,
	const git_diff_options *opts);

extern int git_diff__paired_foreach(git_diff *idx2head,
	git_diff *wd2idx,
...
typedef git_diff_delta *(*git_diff__merge_cb)(const git_diff_delta *left,
	const git_diff_delta *right,
	git_pool *pool);

extern int git_diff__merge(git_diff *onto, const git_diff *from, git_diff__merge_cb cb);

extern git_diff_delta *git_diff__merge_like_cgit(const git_diff_delta *a,
...
extern int git_diff__oid_for_entry(git_oid *out,
	git_diff *diff,
 ...
 */
GIT_INLINE(int)
git_diff_file__resolve_zero_size(git_diff_file *file,
