...
static int parse_section_header_ext(git_config_parser *reader, const char *line,
	const char *base_name, char **section_name)
{
	int c, rpos;
...
static int parse_name(char **name, const char **value,
	git_config_parser *reader, const char *line)
{
