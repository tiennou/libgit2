...
static int pack_backend__read_header(
	size_t *len_p, git_otype *type_p, struct git_odb_backend *backend, const git_oid *oid)
{
...
static int pack_backend__read(void **buffer_p,
	size_t *len_p,
	git_otype *type_p,
...
static int pack_backend__read_prefix(git_oid *out_oid,
	void **buffer_p,
	size_t *len_p,
	git_otype *type_p,
	git_odb_backend *backend,
