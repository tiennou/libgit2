 ...
 */
GIT_INLINE(bool)
git__add_uint64_overflow(uint64_t *out, uint64_t one, uint64_t two)
{
 ...
 */
GIT_INLINE(bool)
git__add_sizet_overflow(size_t *out, size_t one, size_t two)
{
	if (SIZE_MAX - one < two)
		return true;
	*out = one + two;
 ...
 */
GIT_INLINE(bool)
git__multiply_sizet_overflow(size_t *out, size_t one, size_t two)
{
