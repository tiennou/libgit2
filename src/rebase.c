...
static int rebase_state_type(git_rebase_type_t *type_out,
	char **path_out,
	git_repository *repo)
{
...
int git_rebase_open(git_rebase **out, git_repository *repo, const git_rebase_options *given_opts)
{
	git_rebase *rebase;
...
static int rebase_setupfile(git_rebase *rebase,
	const char *filename,
	int flags,
	const char *fmt,
	...)
