 ...
 */
GIT_EXTERN(int)
git_index_add_frombuffer(git_index *index, const git_index_entry *entry,
 ...
 */
GIT_EXTERN(int)
git_index_add_all(git_index *index, const git_strarray *pathspec,
 ...
 */
GIT_EXTERN(int)
git_index_remove_all(git_index *index, const git_strarray *pathspec,
 ...
 */
GIT_EXTERN(int)
git_index_update_all(git_index *index, const git_strarray *pathspec,
	git_index_matched_path_cb callback, void *payload);
 ...
 */
GIT_EXTERN(int)
git_index_conflict_add(git_index *index, const git_index_entry *ancestor_entry,
