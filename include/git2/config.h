 ...
 */
GIT_EXTERN(int)
git_config_add_file_ondisk(git_config *cfg, const char *path,
...
git_config_open_level(
	git_config **out, const git_config *parent, git_config_level_t level);
 ...
 */
GIT_EXTERN(int)
git_config_get_multivar_foreach(const git_config *cfg, const char *name,
 ...
 */
GIT_EXTERN(int)
git_config_multivar_iterator_new(git_config_iterator **out,
 ...
 */
GIT_EXTERN(int)
git_config_foreach_match(const git_config *cfg, const char *regexp,
 ...
 */
GIT_EXTERN(int)
git_config_get_mapped(int *out, const git_config *cfg, const char *name,
 ...
 */
GIT_EXTERN(int)
git_config_backend_foreach_match(git_config_backend *backend,
	const char *regexp, git_config_foreach_cb callback, void *payload);
