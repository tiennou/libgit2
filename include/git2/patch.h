 ...
 */
GIT_EXTERN(int)
git_patch_from_blobs(git_patch **out,
 ...
 */
GIT_EXTERN(int)
git_patch_from_blob_and_buffer(git_patch **out,
	const git_blob *old_blob,
	const char *old_as_path,
	const void *buffer,
	size_t buffer_len,
 ...
 */
GIT_EXTERN(int)
git_patch_from_buffers(git_patch **out,
 ...
 */
GIT_EXTERN(int)
git_patch_line_stats(size_t *total_context,
 ...
 */
GIT_EXTERN(int)
git_patch_get_hunk(const git_diff_hunk **out,
 ...
 */
GIT_EXTERN(int)
git_patch_get_line_in_hunk(const git_diff_line **out,
	git_patch *patch,
	size_t hunk_idx,
	size_t line_of_hunk);
 ...
 */
GIT_EXTERN(size_t)
git_patch_size(git_patch *patch,
	int include_context,
