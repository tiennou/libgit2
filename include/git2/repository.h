 ...
 */
GIT_EXTERN(int)
git_repository_discover(git_buf *out,
 ...
 */
GIT_EXTERN(int)
git_repository_open_ext(git_repository **out,
	const char *path,
	unsigned int flags,
	const char *ceiling_dirs);
 ...
 */
GIT_EXTERN(int)
git_repository_init_ext(git_repository **out,
 ...
 */
GIT_EXTERN(int)
git_repository_head_for_worktree(git_reference **out,
	git_repository *repo,
	const char *name);
 ...
 */
GIT_EXTERN(int)
git_repository_item_path(git_buf *out,
 ...
 */
GIT_EXTERN(int)
git_repository_hashfile(git_oid *out,
	git_repository *repo,
	const char *path,
	git_otype type,
	const char *as_path);
 ...
 */
GIT_EXTERN(int)
git_repository_set_head_detached_from_annotated(git_repository *repo,
