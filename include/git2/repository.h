 ...
 */
GIT_EXTERN(int)
git_repository_discover(git_buf *out, const char *start_path, int across_fs,
 ...
 */
GIT_EXTERN(int)
git_repository_open_ext(git_repository **out, const char *path,
 ...
 */
GIT_EXTERN(int)
git_repository_init_ext(git_repository **out, const char *repo_path,
...
typedef int (*git_repository_fetchhead_foreach_cb)(const char *ref_name,
	const char *remote_url, const git_oid *oid, unsigned int is_merge, void *payload);
 ...
 */
GIT_EXTERN(int)
git_repository_fetchhead_foreach(git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_repository_mergehead_foreach(git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_repository_hashfile(git_oid *out, git_repository *repo, const char *path,
	git_otype type, const char *as_path);
