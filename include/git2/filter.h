 ...
 */
GIT_EXTERN(int)
git_filter_list_load(git_filter_list **filters,
	git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_filter_list_apply_to_file(git_buf *out,
 ...
 */
GIT_EXTERN(int)
git_filter_list_stream_data(git_filter_list *filters,
	git_buf *data,
 ...
 */
GIT_EXTERN(int)
git_filter_list_stream_file(git_filter_list *filters,
	git_repository *repo,
	const char *path,
	git_writestream *target);
 ...
 */
GIT_EXTERN(int)
git_filter_list_stream_blob(git_filter_list *filters,
	git_blob *blob,
	git_writestream *target);
