 ...
 */
GIT_EXTERN(int)
git_annotated_commit_from_ref(git_annotated_commit **out,
	git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_annotated_commit_from_fetchhead(git_annotated_commit **out,
	git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_annotated_commit_lookup(git_annotated_commit **out,
	git_repository *repo,
	const git_oid *id);
 ...
 */
GIT_EXTERN(int)
git_annotated_commit_from_revspec(git_annotated_commit **out,
	git_repository *repo,
	const char *revspec);
