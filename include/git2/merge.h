 ...
 */
GIT_EXTERN(int)
git_merge_file(git_merge_file_result *out,
 ...
 */
GIT_EXTERN(int)
git_merge_file_from_index(git_merge_file_result *out,
	git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_merge_commits(git_index **out,
	git_repository *repo,
