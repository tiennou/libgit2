 ...
 */
GIT_EXTERN(int)
git_describe_commit(git_describe_result **result, git_object *committish,
 ...
 */
GIT_EXTERN(int)
git_describe_workdir(git_describe_result **out, git_repository *repo,
	git_describe_options *opts);
 ...
 */
GIT_EXTERN(int)
git_describe_format(git_buf *out, const git_describe_result *result,
