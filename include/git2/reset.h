 ...
 */
GIT_EXTERN(int)
git_reset(git_repository *repo, const git_object *target,
 ...
 */
GIT_EXTERN(int)
git_reset_from_annotated(git_repository *repo, const git_annotated_commit *commit,
	git_reset_t reset_type, const git_checkout_options *checkout_opts);
 ...
 */
GIT_EXTERN(int)
git_reset_default(git_repository *repo, const git_object *target,
