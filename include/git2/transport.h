...
typedef int (*git_cred_sign_callback)(LIBSSH2_SESSION *session, unsigned char **sig,
...
typedef void (*git_cred_ssh_interactive_callback)(const char *name,
	int name_len, const char *instruction, int instruction_len, int num_prompts,
...
git_cred_userpass_plaintext_new(
	git_cred **out, const char *username, const char *password);
 ...
 */
GIT_EXTERN(int)
git_cred_ssh_key_new(git_cred **out, const char *username,
 ...
 */
GIT_EXTERN(int)
git_cred_ssh_interactive_new(git_cred **out, const char *username,
 ...
 */
GIT_EXTERN(int)
git_cred_ssh_custom_new(git_cred **out, const char *username, const char *publickey,
 ...
 */
GIT_EXTERN(int)
git_cred_ssh_key_memory_new(git_cred **out, const char *username,
	const char *publickey, const char *privatekey, const char *passphrase);
 ...
 */
typedef int (*git_cred_acquire_cb)(git_cred **cred, const char *url,
