...
GIT_EXTERN(int)
git_odb_read_header(
	size_t *len_out, git_otype *type_out, git_odb *db, const git_oid *id);
 ...
 */
GIT_EXTERN(int)
git_odb_open_rstream(git_odb_stream **out, size_t *len, git_otype *type,
 ...
 */
GIT_EXTERN(int)
git_odb_write_pack(git_odb_writepack **out, git_odb *db,
