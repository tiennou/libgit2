 ...
 */
typedef int (
	*git_diff_file_cb)(const git_diff_delta *delta, float progress, void *payload);
 ...
 */
typedef int (*git_diff_binary_cb)(const git_diff_delta *delta,
 ...
 */
GIT_EXTERN(int)
git_diff_stats_to_buf(git_buf *out,
 ...
 */
GIT_EXTERN(int)
git_diff_format_email(git_buf *out,
	git_diff *diff,
 ...
 */
GIT_EXTERN(int)
git_diff_format_email_init_options(git_diff_format_email_options *opts,
	unsigned int version);
