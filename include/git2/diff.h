 ...
 */
GIT_EXTERN(size_t)
git_diff_num_deltas(const git_diff *diff);
 ...
 */
GIT_EXTERN(int)
git_diff_is_sorted_icase(const git_diff *diff);
 ...
 */
GIT_EXTERN(char)
git_diff_status_char(git_delta_t status);
 ...
 */
GIT_EXTERN(void)
git_diff_stats_free(git_diff_stats *stats);
