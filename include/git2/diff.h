 ...
 *		continues.
 */
typedef int (*git_diff_notify_cb)(const git_diff *diff_so_far,
	const git_diff_delta *delta_to_add, const char *matched_pathspec, void *payload);
 ...
 */
typedef int (*git_diff_progress_cb)(const git_diff *diff_so_far,
	const char *old_path, const char *new_path, void *payload);
 ...
 */
GIT_EXTERN(int)
git_diff_init_options(git_diff_options *opts, unsigned int version);
...
typedef struct {
	...
	int (*buffer_signature)(void **out, const git_diff_file *file,
...
#define GIT_DIFF_FIND_OPTIONS_INIT    \
	{                                 \
 ...
 */
GIT_EXTERN(int)
git_diff_find_init_options(git_diff_find_options *opts, unsigned int version);
 ...
 */
GIT_EXTERN(int)
git_diff_tree_to_tree(git_diff **diff, git_repository *repo, git_tree *old_tree,
	git_tree *new_tree,
 ...
 */
GIT_EXTERN(int)
git_diff_tree_to_index(git_diff **diff, git_repository *repo,
	git_tree *old_tree, git_index *index,
	const git_diff_options *opts); /**< can be NULL for defaults */
 ...
 */
GIT_EXTERN(int)
git_diff_index_to_workdir(git_diff **diff, git_repository *repo, git_index *index,
	const git_diff_options *opts); /**< can be NULL for defaults */
 ...
 */
GIT_EXTERN(int)
git_diff_tree_to_workdir(git_diff **diff, git_repository *repo, git_tree *old_tree,
	const git_diff_options *opts); /**< can be NULL for defaults */
 ...
 */
GIT_EXTERN(int)
git_diff_tree_to_workdir_with_index(git_diff **diff, git_repository *repo,
	git_tree *old_tree,
	const git_diff_options *opts); /**< can be NULL for defaults */
 ...
 */
GIT_EXTERN(int)
git_diff_index_to_index(git_diff **diff, git_repository *repo,
	git_index *old_index, git_index *new_index,
	const git_diff_options *opts); /**< can be NULL for defaults */
 ...
 */
GIT_EXTERN(int) git_diff_merge(git_diff *onto, const git_diff *from);
 ...
 */
GIT_EXTERN(int)
git_diff_find_similar(git_diff *diff, const git_diff_find_options *options);
 ...
 */
GIT_EXTERN(size_t)
git_diff_num_deltas_of_type(const git_diff *diff, git_delta_t type);
...
git_diff_get_delta(const git_diff *diff, size_t idx);
 ...
 */
GIT_EXTERN(int)
git_diff_foreach(git_diff *diff, git_diff_file_cb file_cb, git_diff_binary_cb binary_cb,
 ...
 */
GIT_EXTERN(int)
git_diff_print(git_diff *diff, git_diff_format_t format,
 ...
 */
GIT_EXTERN(int)
git_diff_to_buf(git_buf *out, git_diff *diff, git_diff_format_t format);
 ...
 */
GIT_EXTERN(int)
git_diff_blobs(const git_blob *old_blob, const char *old_as_path,
 ...
 */
GIT_EXTERN(int)
git_diff_blob_to_buffer(const git_blob *old_blob, const char *old_as_path,
	const char *buffer, size_t buffer_len, const char *buffer_as_path,
	const git_diff_options *options, git_diff_file_cb file_cb,
 ...
 */
GIT_EXTERN(int)
git_diff_buffers(const void *old_buffer, size_t old_len,
	const char *old_as_path, const void *new_buffer, size_t new_len,
	const char *new_as_path, const git_diff_options *options,
	git_diff_file_cb file_cb, git_diff_binary_cb binary_cb,
	git_diff_hunk_cb hunk_cb, git_diff_line_cb line_cb, void *payload);
 ...
 */
GIT_EXTERN(int)
git_diff_from_buffer(git_diff **out, const char *content, size_t content_len);
 ...
 */
GIT_EXTERN(int) git_diff_get_stats(git_diff_stats **out, git_diff *diff);
 ...
 */
GIT_EXTERN(size_t) git_diff_stats_files_changed(const git_diff_stats *stats);
 ...
 */
GIT_EXTERN(size_t) git_diff_stats_insertions(const git_diff_stats *stats);
 ...
 */
GIT_EXTERN(size_t) git_diff_stats_deletions(const git_diff_stats *stats);
 ...
 */
GIT_EXTERN(int)
git_diff_stats_to_buf(git_buf *out, const git_diff_stats *stats,
...
#define GIT_DIFF_FORMAT_EMAIL_OPTIONS_INIT                                     \
	{                                                                          \
		GIT_DIFF_FORMAT_EMAIL_OPTIONS_VERSION, 0, 1, 1, NULL, NULL, NULL, NULL \
	}
...
git_diff_format_email(
	git_buf *out, git_diff *diff, const git_diff_format_email_options *opts);
 ...
 */
GIT_EXTERN(int)
git_diff_commit_as_email(git_buf *out, git_repository *repo, git_commit *commit,
	size_t patch_no, size_t total_patches, git_diff_format_email_flags_t flags,
...
#define GIT_DIFF_PATCHID_OPTIONS_INIT    \
	{                                    \
 ...
 */
GIT_EXTERN(int)
git_diff_patchid_init_options(git_diff_patchid_options *opts, unsigned int version);
 ...
 */
GIT_EXTERN(int)
git_diff_patchid(git_oid *out, git_diff *diff, git_diff_patchid_options *opts);
