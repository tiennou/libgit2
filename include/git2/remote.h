 ...
 */
GIT_EXTERN(int)
git_remote_create_with_fetchspec(git_remote **out,
	git_repository *repo,
	const char *name,
	const char *url,
	const char *fetch);
 ...
 */
GIT_EXTERN(int)
git_remote_connect(git_remote *remote,
 ...
 */
GIT_EXTERN(int)
git_remote_fetch(git_remote *remote,
...
GIT_EXTERN(int)
git_remote_rename(
	git_strarray *problems, git_repository *repo, const char *name, const char *new_name);
