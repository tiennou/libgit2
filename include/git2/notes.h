...
git_note_iterator_new(
	git_note_iterator **out, git_repository *repo, const char *notes_ref);
 ...
 */
GIT_EXTERN(int)
git_note_commit_iterator_new(git_note_iterator **out, git_commit *notes_commit);
 ...
 */
GIT_EXTERN(int)
git_note_next(git_oid *note_id, git_oid *annotated_id, git_note_iterator *it);
 ...
 */
GIT_EXTERN(int)
git_note_read(git_note **out, git_repository *repo, const char *notes_ref,
	const git_oid *oid);
 ...
 */
GIT_EXTERN(int)
git_note_commit_read(git_note **out, git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_note_create(git_oid *out, git_repository *repo, const char *notes_ref,
 ...
 */
GIT_EXTERN(int)
git_note_commit_create(git_oid *notes_commit_out, git_oid *notes_blob_out,
 ...
 */
GIT_EXTERN(int)
git_note_remove(git_repository *repo, const char *notes_ref,
 ...
 */
GIT_EXTERN(int)
git_note_commit_remove(git_oid *notes_commit_out, git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_note_foreach(git_repository *repo, const char *notes_ref,
