 ...
 */
GIT_EXTERN(int)
git_branch_create(git_reference **out, git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_branch_create_from_annotated(git_reference **ref_out, git_repository *repository,
 ...
 */
GIT_EXTERN(int)
git_branch_move(git_reference **out, git_reference *branch,
 ...
 */
GIT_EXTERN(int)
git_branch_lookup(git_reference **out, git_repository *repo,
...
git_branch_remote_name(
	git_buf *out, git_repository *repo, const char *canonical_branch_name);
