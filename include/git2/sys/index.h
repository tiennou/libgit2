 ...
 */
GIT_EXTERN(size_t)
git_index_name_entrycount(git_index *index);
 ...
 */
GIT_EXTERN(int)
git_index_name_add(git_index *index,
 ...
 */
GIT_EXTERN(void)
git_index_name_clear(git_index *index);
 ...
 */
GIT_EXTERN(size_t)
git_index_reuc_entrycount(git_index *index);
 ...
 */
GIT_EXTERN(int)
git_index_reuc_add(git_index *index, const char *path,
 ...
 */
GIT_EXTERN(int)
git_index_reuc_remove(git_index *index, size_t n);
 ...
 */
GIT_EXTERN(void)
git_index_reuc_clear(git_index *index);
