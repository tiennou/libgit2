...
struct git_config_backend {
	...
	int (*set_multivar)(git_config_backend *cfg, const char *name,
		const char *regexp, const char *value);
	int (*del)(struct git_config_backend *, const char *key);
	int (*del_multivar)(
		struct git_config_backend *, const char *key, const char *regexp);
 ...
 */
GIT_EXTERN(int)
git_config_add_backend(git_config *cfg, git_config_backend *file,
