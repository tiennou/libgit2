...
struct git_transport {
	...
	int (*set_custom_headers)(git_transport *transport,
		const git_strarray *custom_headers);

	/* Connect the transport to the remote repository, using the given
	 * direction. */
	int (*connect)(git_transport *transport,
		const char *url,
	...
	int (*push)(git_transport *transport,
		git_push *push,
	...
	int (*negotiate_fetch)(git_transport *transport,
		git_repository *repo,
	...
	int (*download_pack)(git_transport *transport,
		git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_transport_dummy(git_transport **out,
	git_remote *owner,
	/* NULL */ void *payload);
 ...
 */
GIT_EXTERN(int)
git_transport_local(git_transport **out,
	git_remote *owner,
	/* NULL */ void *payload);
 ...
 */
GIT_EXTERN(int)
git_transport_smart(git_transport **out,
	git_remote *owner,
 ...
 */
GIT_EXTERN(int)
git_transport_smart_certificate_check(git_transport *transport,
	git_cert *cert,
	int valid,
	const char *hostname);
 ...
 */
GIT_EXTERN(int)
git_transport_smart_credentials(git_cred **out,
...
struct git_smart_subtransport_stream {
	...
	int (*read)(git_smart_subtransport_stream *stream,
		char *buffer,
		size_t buf_size,
		size_t *bytes_read);
 ...
 */
GIT_EXTERN(int)
git_smart_subtransport_http(git_smart_subtransport **out, git_transport *owner, void *param);
 ...
 */
GIT_EXTERN(int)
git_smart_subtransport_git(git_smart_subtransport **out, git_transport *owner, void *param);
 ...
 */
GIT_EXTERN(int)
git_smart_subtransport_ssh(git_smart_subtransport **out, git_transport *owner, void *param);
