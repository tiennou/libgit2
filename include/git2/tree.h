 ...
 */
GIT_EXTERN(int)
git_tree_lookup(git_tree **out, git_repository *repo, const git_oid *id);
 ...
 */
GIT_EXTERN(int)
git_tree_lookup_prefix(git_tree **out, git_repository *repo, const git_oid *id, size_t len);
...
git_tree_entry_byname(const git_tree *tree, const char *filename);
 ...
 */
GIT_EXTERN(const git_tree_entry *)
git_tree_entry_byindex(const git_tree *tree, size_t idx);
 ...
 */
GIT_EXTERN(const git_tree_entry *)
git_tree_entry_byid(const git_tree *tree, const git_oid *id);
 ...
 */
GIT_EXTERN(int)
git_tree_entry_bypath(git_tree_entry **out, const git_tree *root, const char *path);
 ...
 */
GIT_EXTERN(int)
git_tree_entry_to_object(git_object **object_out,
	git_repository *repo,
 ...
 */
GIT_EXTERN(int)
git_treebuilder_new(git_treebuilder **out, git_repository *repo, const git_tree *source);
 ...
 */
GIT_EXTERN(int)
git_treebuilder_insert(const git_tree_entry **out,
	git_treebuilder *bld,
	const char *filename,
	const git_oid *id,
 ...
 */
GIT_EXTERN(void)
git_treebuilder_filter(git_treebuilder *bld, git_treebuilder_filter_cb filter, void *payload);
 ...
 * @return 0 or an error code
 */
GIT_EXTERN(int) git_treebuilder_write(git_oid *id, git_treebuilder *bld);
 ...
 */
GIT_EXTERN(int)
git_treebuilder_write_with_buffer(git_oid *oid, git_treebuilder *bld, git_buf *tree);

/** Callback for the tree traversal method */
typedef int (
	*git_treewalk_cb)(const char *root, const git_tree_entry *entry, void *payload);
 ...
 */
GIT_EXTERN(int)
git_tree_walk(const git_tree *tree,
 ...
 */
GIT_EXTERN(int)
git_tree_create_updated(git_oid *out,
	git_repository *repo,
	git_tree *baseline,
	size_t nupdates,
