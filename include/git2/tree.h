 ...
 */
GIT_EXTERN(int)
git_treebuilder_insert(const git_tree_entry **out, git_treebuilder *bld,
 ...
 */
GIT_EXTERN(int)
git_tree_walk(const git_tree *tree, git_treewalk_mode mode,
 ...
 */
GIT_EXTERN(int)
git_tree_create_updated(git_oid *out, git_repository *repo, git_tree *baseline,
